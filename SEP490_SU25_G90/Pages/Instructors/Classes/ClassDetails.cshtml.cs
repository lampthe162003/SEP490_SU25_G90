...
namespace SEP490_SU25_G90.Pages.Instructors.Classes
{
    ...
    public class ClassDetailsModel : PageModel
    {
        ...
        public string CreatePagingUrl(int pageNumber)
        {
            ...
            if (pageNumber <= 1)
            {
                return $"/Instructors/Classes/ClassDetails/{classId}";
            }
            return $"/Instructors/Classes/ClassDetails/{classId}?page={pageNumber}";
        }
        ...
        {
            return "/Instructors/Classes/ListClasses";
        }
        ...
        public string CreateInstructorUrl()
        {
            ...
            {
                return $"/Instructors/LearningProfile/InstructorDetail?id={ClassDetail.InstructorId.Value}";
            }
            return "#";
        }
