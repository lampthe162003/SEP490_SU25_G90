...
{
    /// <summary>
    /// Page model cho màn hình chi tiết lớp học (Admin)
    /// </summary>
    ...
    public class ClassDetailsModel : PageModel
    {
        ...
        public string CreatePagingUrl(int pageNumber)
        {
            ...
            if (pageNumber <= 1)
            {
                return $"/Admins/Classes/ClassDetails/{classId}";
            }
            return $"/Admins/Classes/ClassDetails/{classId}?page={pageNumber}";
        }
        ...
        {
            return "/Admins/Classes/ListClasses";
        }
        ...
        {
            var classId = Id ?? ClassDetail.ClassId;
            return $"/Admins/Classes/UpdateClasses?id={classId}";
        }
        ...
        public string CreateInstructorUrl()
        {
            ...
            {
                return $"/Admins/LearningProfile/InstructorDetail?id={ClassDetail.InstructorId.Value}";
            }
            return "#";
        }
        ...
        {
            return $"/Admins/LearningProfile/LearnerDetail?id={learnerId}";
        }
